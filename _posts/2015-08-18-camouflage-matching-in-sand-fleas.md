---
title: "Camouflage matching in sand fleas"
image: /assets/images/posts/camouflage-matching-in-sand-fleas/main.jpg
excerpt: "Sand fleas have a remarkable ability to change colour in order to match dramatically different…"
date: 2015-08-18 09:15:25 +0000
themes: [visual-ecology]
original_url: https://www.jolyon.co.uk/2015/08/camouflage-matching-in-sand-fleas/
---

Sand fleas have a remarkable ability to change colour in order to match dramatically different backgrounds, as revealed in our [paper just out in Biology Letters](http://rsbl.royalsocietypublishing.org/content/11/8/20150494).
...
The sand fleas, also known as mole crabs, were photographed in the lab along with sand from their respective beaches. The images were transformed to correspond to an avian visual system using specially designed software by the team to determine how camouflaged the fleas would appear to a predatory bird. The results showed that the sand fleas matched the colour and brightness of the beaches they lived on, affording them camouflage against predators.
